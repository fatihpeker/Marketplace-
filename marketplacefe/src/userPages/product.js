...
import { getFavorite } from "../favoriteList/listOfFavorite";
import {isIn} from "../favoriteList/listOfFavorite"
...
class Product extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <TopMenu product={products} ></TopMenu>
      <Grid
        textAlign="center"
        style={{ height: "100vh" }}
                  ...
                  return (
                    <Table.Row>
                      <Table.Cell>
                        ...
                        {isIn(value.id) ? <Icon color="green" name="check" >favorite</Icon>  : <AddFavorite callFav={getFavorite} callProducts={this.getProducts} productId={value.id} ></AddFavorite>}
                        {/* <DelFavorite callback={null} productId={value.id} ></DelFavorite> */}
                      </Table.Cell>
