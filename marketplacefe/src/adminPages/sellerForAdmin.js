...
import DeleteSeller from "./adminComponent/deleteSeller";
import UpdateSellerButton from "./adminComponent/updateSellerButton"
...
class Seller extends React.Component {
  ...
  getSeller = () => {
    ...
    fetch("http://localhost:8080/api/1.0/admin/getAllSeller?" + new URLSearchParams({ pageNumber: this.state.currentPage,pageSize: pageSize }), {
      method: "GET",
      headers: {
                  ...
                  return (
                    <Table.Row>
                      <Table.Cell>
                        ...
                        <DeleteSeller callback={this.getSeller} sellerId={value.id} ></DeleteSeller>
                        <UpdateSellerButton id={value.id} ></UpdateSellerButton>
                      </Table.Cell>
